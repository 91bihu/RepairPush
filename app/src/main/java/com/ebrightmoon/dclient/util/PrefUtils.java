...
public class PrefUtils {
    ...
    public interface KEY {
        ...
        String TOKEN="token";
        String REPEAT_QUOTE="repeat_quote";
        String AGENT_NAME="agent_name";
        String TOP_AGENT_ID="top_agent_id";
...
//            return oldKey;
//        } else if (oldKey.equals(KEY.USER_ID)) {
//            return oldKey;
//        } else if (oldKey.equals(KEY.USER_GUSTURE)) {
//            return oldKey;
//        } else if (oldKey.equals(KEY.IDCARD)) {
//            return oldKey;
//        } else if (oldKey.equals(KEY.CITYID)) {
//            return oldKey;
//        } else if (oldKey.equals(KEY.PROVINCEID)) {
//            return oldKey;
//        } else if (oldKey.equals(KEY.TEAM_ID)) {
//            return oldKey;
//        } else if (oldKey.equals(KEY.TEAM_ID)) {
//            return oldKey;
//        }
